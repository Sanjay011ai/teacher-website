          ...
          <div className="lg:col-span-1">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter a topic and AI will create a comprehensive educational document with detailed content and images
                </CardDescription>
              </CardHeader>
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Enter a topic and click "Generate PDF" to create a comprehensive educational document with detailed
                    content and images.
                  </p>
                </CardContent>
              </Card>
